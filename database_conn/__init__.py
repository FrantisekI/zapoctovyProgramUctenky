...
class Database:
    ...
    if __name__ == "__main__":
        ...
        from _select_by_key import _find_custom_names_by_bands, find_similar_shops, find_all_products, select_all_classes, select_all_products_by_class
    else:
        ...
        from database_conn._select_by_key import _find_custom_names_by_bands, find_similar_shops, find_all_products, select_all_classes, select_all_products_by_class
