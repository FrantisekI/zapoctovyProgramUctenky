...
class Database:
    ...
    if __name__ == "__main__":
        PRE = ""
        from _select_one import select_one_bought_item, select_one_config, select_one_custom_product_name, select_one_product_class, select_one_shop, select_one_band
        ...
        from _select_by_key import _find_custom_names_by_bands
    else:
        from database_conn._select_one import select_one_bought_item, select_one_config, select_one_custom_product_name, select_one_product_class, select_one_shop, select_one_band
        ...
        from database_conn._select_by_key import _find_custom_names_by_bands
