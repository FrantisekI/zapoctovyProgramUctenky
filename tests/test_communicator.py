...
class TestCommunicator(unittest.TestCase):
    ...
    def test_pretty_print(self):
        store_info = ("Test Store", "2023-10-01", "100.00")
        assigned_products = [
            {'name': 'Product 1', 'total_price': 10.00, 'amount': 1, 'units': 'pcs', 'class': {(1,'A')}, 'flag': 10},
            {'name': 'Product 2', 'total_price': 20.00, 'amount': 2, 'units': 'pcs', 'class': {(2,'B'), (3,'C')}, 'flag': 20},
            {'name': 'Product 3', 'total_price': 30.00, 'amount': 3, 'units': 'pcs', 'class': None, 'flag': 21},
        ]
